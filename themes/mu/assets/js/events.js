...
Events.text = [
	['Начнётся через', '<font color="green">Открыт, до начала</font>'],
	['Появится через', '<font color="red">Торопись, осталось</font>']
];
...
Events.sked = [
	...
	[' - Golden Invasion', 1, '00:15', '04:15', '08:15', '12:15', '16:15', '20:15'],
	[' - Loren Deep', 1, '11:15'],
	[' - HAPPY HOUR', 1, '20:00'],
];
